...
export const slug = 'how-to-use-react-to-generate-og-images';

export const metadata = {
  title: 'How to use React to generate your own OpenGraph images',
  description:
    "Let's use the power of React together with Puppeteer / Playwright to style and generate dynamic images on the fly.",
  openGraph: {
    type: 'article',
