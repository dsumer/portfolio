...
export const slug = 'how-my-first-side-project-made-me-the-developer-i-am-today';

export const metadata = {
  title: 'How my first side project made me the developer I am today',
  description:
    ' I am telling the story of my first real side project in software development and how it shaped my career as a software developer.',
  openGraph: {
    type: 'article',
