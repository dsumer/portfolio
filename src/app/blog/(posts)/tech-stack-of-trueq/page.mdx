...
export const slug = 'tech-stack-of-trueq';

export const metadata = {
  title: 'The tech stack of our first SaaS and what we regret',
  description:
    'I describe the tech stack and how we do the deployment of our first SaaS called TrueQ. Additionally I explain what we regret about our decisions / would to differently nowadays.',
  openGraph: {
    type: 'article',
