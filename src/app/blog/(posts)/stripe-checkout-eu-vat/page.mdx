...
export const slug = 'stripe-checkout-eu-vat';

export const metadata = {
  title: 'A guide to make your Stripe Checkout EU VAT compliant',
  description:
    'In this blog post I am covering the different scenarios which need to be considered when selling digital goods inside the EU and how to implement them with Stripe Checkout.',
  openGraph: {
    type: 'article',
