...
export const slug = 'how-and-why-to-start-blogging';

export const metadata = {
  title: 'How and why to start blogging',
  description:
    'Tips about how and why to start an own blog. What benefits you get from blogging, how you can motivate yourself to start with it and how to find the right topics.',
  openGraph: {
    type: 'article',
